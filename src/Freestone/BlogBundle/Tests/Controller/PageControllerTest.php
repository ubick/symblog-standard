...
class PageControllerTest extends WebTestCase {
    ...
    public function testContact() {
        ...
        $form['contact[age]'] = '25';
        $form['contact[email]'] = 'liviu.panainte@freestone.co.uk';
        ...
        if ($profile = $client->getProfile()) {
            ...
            $symblogEmail = $client->getContainer()->getParameter('freestone_blog.emails.contact_email');
        ...
        $this->assertEquals(1, $crawler->filter('.blogger-notice:contains("Your contact enquiry was succesfully sent")')->count());
    }
