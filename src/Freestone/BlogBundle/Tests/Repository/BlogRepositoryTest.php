...
namespace Freestone\BlogBundle\Tests\Repository;

use Freestone\BlogBundle\Repository\BlogRepository;
use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;

class BlogRepositoryTest extends WebTestCase {

    /**
     * @var \Freestone\BlogBundle\Repository\BlogRepository
     */
    ...
    public function setUp() {
        ...
        $this->blogRepository = $kernel->getContainer()
            ...
            ->getRepository('FreestoneBlogBundle:Blog');
    }
